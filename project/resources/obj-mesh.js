 ...
 * -il caricamento asincrono di una mesh,
 * -la creazione di un oggetto Mesh tramite il quale si possa facilmente accedere a tutte le sue proprietà (matrice di movimento, liste di vertici, normali e coord. texture, materiale, texture...).
 *	Sempre nel costruttore vengono anche creati i buffer relativi a quell'oggetto e caricati con i dati opportuni.
 * -il disegno della mesh: riceve in ingresso un oggetto mesh, associa gli attribute e gli uniform del programma correntemente in uso ai dati opportuni e infine disegna con la chiamata alla drawArrays/DrawElements.
 */
 ...
 * @param material:				materiale con cui renderizzare la mesh
 * @param texture:				texture da applicare alla mesh
 */
